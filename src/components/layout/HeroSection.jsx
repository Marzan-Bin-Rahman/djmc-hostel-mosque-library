...
const HeroSection = () => {
    return (
        <div className="relative w-full h-screen bg-cover bg-black/70 bg-blend-overlay bg-center rounded-xl" style={{ backgroundImage: "url(https://i.postimg.cc/06xPH2rv/image.jpg)" }}>
